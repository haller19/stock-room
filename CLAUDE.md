...
When deploying changes, increment `CACHE_VERSION` in `service-worker.js` line 3 (e.g., `'zaiko-v19'` → `'zaiko-v20'`). Also update the version label in `index.html` header (`<span>v19</span>`).
